...
func RegChapter3(Ctrl *Controller) {
	Ctrl.Register(&ChapterConfig{
		Name:       "chapter3",
		Enabled:    true,
		MaxRetries: 3,
		Stages: []Stage{
			{
				...
				Run: func() (info.RecoveryAction, error) {
					return FindChapter(
						info_chapter.Ch3.ChapterImg_path,
						info_chapter.Ch3.Type_,
					)
				},
			},
			{
				...
				Run: func() (info.RecoveryAction, error) {
					return Chapter_Tp(
						info_chapter.Ch3.MapConfig[0].MapFind.MapColorsCmp,
						info_chapter.Ch3.MapConfig[0].TpPoint,
					)
				},
			},
			{
				...
				Run: func() (info.RecoveryAction, error) {
					return ChapterRun(
						info_chapter.Ch3.MapConfig[0].BigMapPath,
						info_chapter.Ch3.MapConfig[0].Bin_mapPath,
						info_chapter.Ch3.MapConfig[0].MonsterLocation,
						info_chapter.Ch3.YoloLable,
						"main",
					)
				},
			},
			{
				...
				Run: func() (info.RecoveryAction, error) {
					return Chapter_Tp(
						info_chapter.Ch3.MapConfig[1].MapFind.MapColorsCmp,
						info_chapter.Ch3.MapConfig[1].TpPoint,
					)
				},
			},
			{
				...
				Run: func() (info.RecoveryAction, error) {
					return ChapterRun(
						info_chapter.Ch3.MapConfig[1].BigMapPath,
						info_chapter.Ch3.MapConfig[1].Bin_mapPath,
						info_chapter.Ch3.MapConfig[1].MonsterLocation,
						info_chapter.Ch3.YoloLable,
						"main",
					)
				},
