...
// 第一章信息
var Ch1 = info.ChapterConfig{
	ChapterName:     "chapter1",
	ChapterImg_path: path.Join(info.ImgRoot, "misc/chapter1Select.png"),
	Type_:           "main",
	...
	MapConfig: []info.MapConfig{
		{
			...
			BigMapPath:  path.Join(info.ImgRoot, "map/scaled_grey_Extend_chapter1_1.jpg"),
			Bin_mapPath: path.Join(info.ImgRoot, "map/bin_map_chapter1_1.jpg"),
		...
		},
		{
			...
			BigMapPath:  path.Join(info.ImgRoot, "map/scaled_grey_Extend_chapter1_2.jpg"),
			Bin_mapPath: path.Join(info.ImgRoot, "map/bin_map_chapter1_2.jpg"),
			MapFind: info.MapFind{
				Function: "第一章地图2界面找色",
				MapColorsCmp: []info.StructColorCmp{
